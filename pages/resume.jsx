...
const resume = () => {
  return (
    <>
      <Head>
        <title>Enoch | Resume</title>
        <meta
          name="description"
          content="I’m Full-Stack web developer specializing in building exceptional digital experiences."
        />
        <link rel="icon" href="/fav.png" />
      </Head>

      <div className="max-w-[940px] mx-auto p-2 pt-[120px] text-white">
        <h2 className="text-center">Resume</h2>
        <div className="bg-[#d0d4d6] my-4 p-4 w-full flex justify-between items-center">
          <h2 className="text-center">Enoch Promise</h2>
          <div className="flex">
            <a
        ...
        <div className="text-center py-4">
          ...
          <p className="py-2">
            ...
            <span className="px-2">|</span>Front-Stack Web Developer
            ...
            <span className="px-2">|</span>Mongo_db
